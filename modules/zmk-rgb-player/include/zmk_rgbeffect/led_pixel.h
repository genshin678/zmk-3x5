...
/* TEMPORARY: 4-pixel bring-up board (see zmk_3x5_bt.overlay chain-length).
 * This MUST stay equal to chain-length - it is NOT derived from devicetree,
 * so the two have to be changed together. Restore to 15 with the full board. */
